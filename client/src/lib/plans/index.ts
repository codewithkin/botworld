export const plans = {
    free: {
      ...
      messages: 100,
      price: 0,
      productId: import.meta.env.NODE_ENV === "production" ? "prod_7dlxu9H0z4nycn581YDH76" : "prod_3LNHH2Is2Pkk7KQgpm0wIy",
      features: [
        `🤖 1 AI bot`,
        "💬 100 messages/month",
        "📊 Basic analytics",
    ...
    business: {
      ...
      messages: 10000,
      price: 89,
      productId: import.meta.env.NODE_ENV === "production" ? "prod_5MmBhFeoV8ux1Ajt2GmRCK"  : "prod_4JSusrL2XiVARq9hMLGQeq",
      features: [
        "🌟 10 AI bots",
    ...
    unlimited: {
      ...
      messages: Infinity,
      price: 200,
      productId: import.meta.env.NODE_ENV === "production" ? "prod_9xdh9XQ1PHwcNVmYfZazj" : "prod_3dbgjMwLS3TmxTjSTxrWVn",
      features: [
        "🌈 Unlimited bots",
