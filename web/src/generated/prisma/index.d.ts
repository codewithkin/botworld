...
export namespace Prisma {
  ...
  */
  ...
  export type MessageOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> =
    $Extensions.GetOmit<
      'id' | 'botId' | 'userId' | 'sender' | 'contentSnippet' | 'fallback' | 'reply' | 'createdAt',
      ExtArgs['result']['message']
    >;
  ...
  export type DocumentCreateNestedManyWithoutBotInput = {
    create?:
      | XOR<DocumentCreateWithoutBotInput, DocumentUncheckedCreateWithoutBotInput>
  ...
  export type BotUpdateOneRequiredWithoutDocumentsNestedInput = {
    ...
    connect?: BotWhereUniqueInput;
    update?: XOR<
      XOR<BotUpdateToOneWithWhereWithoutDocumentsInput, BotUpdateWithoutDocumentsInput>,
  ...
  export type BotUpdateOneRequiredWithoutMessagesNestedInput = {
    ...
    connect?: BotWhereUniqueInput;
    update?: XOR<
      XOR<BotUpdateToOneWithWhereWithoutMessagesInput, BotUpdateWithoutMessagesInput>,
