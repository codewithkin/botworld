    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <div className="max-w-2xl text-center space-y-6">
        ...
        <div className="space-y-4">
          <h2 className="text-3xl font-semibold tracking-tight">Lost in the Chatosphere?</h2>
          ...
          <div className="py-4 px-6 bg-accent/30 rounded-lg border border-dashed">
            <p className="text-sm text-muted-foreground italic">
              Did you know? The first chatbot ELIZA was created in 1966 - ancient history in bot
              years!
            </p>
          </div>
